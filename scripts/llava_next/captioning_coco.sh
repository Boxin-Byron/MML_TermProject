DEVICE=0
EXP_NAME=COCO_llava-next # results will be saved as $SAVE_FOLDER/$EXP_NAME.jsonl
...
DATASET_TYPE=coco # Dataset type: options are coco, iiw, or docci
# Path to input images
IMAGE_FOLDER="/home/mingi/data/coco/val2014"
